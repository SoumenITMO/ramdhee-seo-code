...
//$baseUrl = '/liliane_taylor/admin/ckfinder/userfiles/';
//$baseUrl = $_SERVER['HTTP_HOST']."/salvus/admin/ckfinder/userfiles/";
$baseUrl = '/exalted_solution/salvus/admin/ckfinder/userfiles/';
/*
