...
class img {
	...
	function resize($width = 120, $height = 120, $aspectradio = true){
		...
		//$whiteBackground = imagecolorallocate($this->temp, 236, 100, 161);  //SET BACKGROUND COLOR
		//imagefill($this->temp,0,0,$whiteBackground);

		$background = imagecolorallocatealpha($this->temp, 0, 0, 0, 127);  // SET BACKGROUND TRANSPARENT
