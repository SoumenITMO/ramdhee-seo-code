<header id="header">
  <div id="logo-group" style="background:#ffffff;">
    <span id="logo"> <img src="https://ramadhee.ee/favicon.ico" alt="<?PHP echo SITE_TITLE; ?>"> </span>
  </div>
  
  <div style="width:75%;height:30px;margin-top:25px;color:red;text-align:center;font-weight:bold;font-size:18px;"></div>
